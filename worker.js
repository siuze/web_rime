(function () {
    ...
    var schemaFiles = {
    	ShanRenMaLTS: ShanRenMaLTS$2,
    	pinyin_simp: pinyin_simp$2
    };

    var ShanRenMaLTS$1 = "siuze/rime-ShanRenMaLTS-web";
    var pinyin_simp$1 = "pinyin-simp";
    var schemaTarget = {
    	ShanRenMaLTS: ShanRenMaLTS$1,
    ...
    var targetFiles = {
    	"siuze/rime-ShanRenMaLTS-web": [
    	{
    		name: "ShanRenMaLTS.prism.bin",
    		md5: "afabc395ef003f58144176dfd778a4be"
    	},
    	{
    		name: "ShanRenMaLTS.reverse.bin",
    		md5: "856bc66189366a9c1f0f2fee6c85fc42"
    	},
    	{
    		name: "ShanRenMaLTS.schema.yaml",
    		md5: "cfbe8029e5446a034cd530334db978b0"
    	},
    	{
    		name: "ShanRenMaLTS.table.bin",
    		md5: "fe1f1adfff5bc23f90e5305b7bef6571"
    	}
    ],
    	"pinyin-simp": [
    	{
    		name: "pinyin_simp.prism.bin",
    		md5: "3b1037493ae93c1f7ae64bea9bc16650"
    	},
    	{
    		name: "pinyin_simp.reverse.bin",
    		md5: "a7691b570c4c4a1a8ca6339f9b6338e8"
    	},
    	{
    		name: "pinyin_simp.schema.yaml",
    		md5: "7101abebdd3155a77b545ed7a19b3681"
    	},
    	{
    		name: "pinyin_simp.table.bin",
    		md5: "18cdf4674c35c6694f96ab10df5ee7be"
    	}
    ]
    };
